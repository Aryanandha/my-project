...
+          <p className="text-xl text-[#555555]">Loading profile...</p>
+        </div>
+      </div>
+    );
+  }
...
+          <p className="text-xl text-[#555555]">{error || 'Profile not found'}</p>
...
-                )}
+                <div className="mb-8">
+                  <h3 className="text-xl font-bold text-[#222222] mb-3">Contact Information</h3>
+                  <div className="bg-[#F5F5F5] rounded-lg p-4">
+                    <p className="text-[#555555] mb-2">
+                      <strong>Service:</strong> {profile.serviceName || 'Service Provider'}
+                    </p>
+                    <p className="text-[#555555] mb-2">
+                      <strong>Location:</strong> {profile.location || 'Location not specified'}
+                    </p>
+                    <p className="text-[#555555]">
+                      <strong>Starting Price:</strong> {profile.price || 'Price on request'}
+                    </p>
+                  </div>
+                </div>
               </div>
...
+                        <p className="font-semibold text-[#222222]">{formatPhoneNumber(profile.phone)}</p>
                       </div>
                     </div>
...
+                        <p className="font-semibold text-[#222222]">{profile.email || 'Email not available'}</p>
                       </div>
                     </div>
                   </div>